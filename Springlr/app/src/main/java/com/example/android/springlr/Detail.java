...
public class Detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        to_log_out=(Button)findViewById(R.id.logOut);
                ...
                Iterator<DataSnapshot> detais=dataSnapshot.getChildren().iterator();
                    ...
                    while (detais.hasNext())
                    {
                        ...
                        if(emailid.equals(currentUser.getEmail()))
                            if(detai.child("name").getValue()!=null)
                                displaydetail.setText(detai.child("name").getValue().toString());
                            else
                                displaydetail.setText(nameofuser.getText().toString());
                        else
                            displaydetail.setText("");
                    }
        ...
        to_log_out.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
